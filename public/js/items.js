var img_candlestick = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/candlestick.png'),
    transparent: true
  });
  ...
  var img_vase = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/vase.png'),
    transparent: true,
  ...
  var img_rake = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/fireplace_tools.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_telepfone = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/telepfone.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_oil_lamp = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/oil_lamp.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_horse = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/horse.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_spider_web = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/spider_web.png'),
    transparent: true
  });
  ...
  var img_group = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/group.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_teapot = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/teapot.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_wood = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/wood.png'),
    transparent: true
  });
  ...
  var img_clock = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/clock.png'),
    transparent: true
  });
  ...
  var img_bucket = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/bucket.png'),
    transparent: true
  });
  ...
  var img_book = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/book.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_lamp = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/lamp.png'),
    transparent: true
  });
  ...
  var img_teddy = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/teddy.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_bat = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/bat.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_ball = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/ball.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_poster = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/poster.png'),
    transparent: true
  });
  ...
  var img_clock_old = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/clock_old.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_old_frame = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/stew.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
  ...
  var img_frame = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/frame.png'),
    transparent: true
  });
  ...
  var img_cup = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/cup.png'),
    transparent: true
  });
  ...
  var img_lock = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load('items/lock.png'),
    transparent: true,
    side: THREE.DoubleSide
  });
